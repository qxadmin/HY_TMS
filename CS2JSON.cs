...
namespace HY.TMS.Common
{
    ...
    public class CS2JSON
    {
        ...
        /// <returns></returns>
        public static string DataTable3Json(DataTable dt, string JsonName)
        {
            return DataTable3Json(dt, JsonName, HTMLEncodeLevel.Light);
        }
        ...
        /// <returns></returns>
        public static string DataTable3Json(DataTable dt, string JsonName, HTMLEncodeLevel encodeLevel)
        {
            //Exception Handling       
            if (dt != null && dt.Rows.Count > 0)
            {
                var JsonString = new StringBuilder();
                JsonString.Append(string.Format("[", JsonName));
        ...
        public static string DataSet2Json(DataSet dataSet)
        {
            ...
            {
                jsonString += DataTable2Json(table, table.TableName) + ",";
            }
